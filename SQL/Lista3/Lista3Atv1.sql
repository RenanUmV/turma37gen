...
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`tb_postagens` (
  ...
  `tb_temas_id_tema` BIGINT NOT NULL,
  PRIMARY KEY (`id`, `tb_usuarios_id`, `tb_temas_id_tema`),
  INDEX `fk_tb_temas_has_tb_usuarios_tb_usuarios1_idx` (`tb_usuarios_id` ASC) VISIBLE,
  INDEX `fk_tb_temas_has_tb_usuarios_tb_temas_idx` (`tb_temas_id_tema` ASC) VISIBLE,
